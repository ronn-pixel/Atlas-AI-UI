  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700 pb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
         <Card className="lg:col-span-2 p-0 overflow-hidden bg-white dark:bg-[#1F2937] border-none rounded-[3rem] shadow-soft flex flex-col">
            <div className="p-10 border-none flex justify-between items-center bg-slate-50/50 dark:bg-black/20">
               ...
               <div className="flex gap-4">
                  <div className="relative">
                    ...
                    <input type="text" placeholder="Filter paths..." className="bg-white dark:bg-[#111827] border-none rounded-xl pl-12 pr-6 h-10 text-[10px] font-black tracking-widest uppercase w-48 outline-none" />
                  </div>
                  <Button variant="outline" className="h-10 w-10 p-0 border-none bg-white dark:bg-[#111827] rounded-xl"><Filter className="w-4 h-4" /></Button>
               </div>
            </div>
               ...
               <table className="w-full text-left border-collapse">
                  <thead>
                     <tr className="bg-slate-50/20 dark:bg-black/10">
                        <th className="px-10 py-6 text-[10px] font-black uppercase tracking-[0.3em] text-text-muted dark:text-slate-600 text-left align-middle">Route ID</th>
                        <th className="px-10 py-6 text-[10px] font-black uppercase tracking-[0.3em] text-text-muted dark:text-slate-600 text-left align-middle">Vendor Node</th>
                        <th className="px-10 py-6 text-[10px] font-black uppercase tracking-[0.3em] text-text-muted dark:text-slate-600 text-left align-middle">Trigger Logic</th>
                        <th className="px-10 py-6 text-[10px] font-black uppercase tracking-[0.3em] text-text-muted dark:text-slate-600 text-left align-middle">Status</th>
                     </tr>
                  </thead>
                  <tbody className="divide-y divide-slate-50 dark:divide-slate-800">
                     {ROUTES.map((r, i) => (
                       <tr key={i} className="hover:bg-slate-50 dark:hover:bg-white/5 transition-all duration-300 group">
                          <td className="px-10 py-8 text-[11px] font-black text-trust dark:text-trust-light tracking-widest tabular-nums text-left">{r.id}</td>
         ...
         <div className="space-y-8">
            <Card className="p-10 border-none bg-white dark:bg-[#1F2937] rounded-[3rem] shadow-soft group">
            ...
            <Card className="p-10 bg-slate-900 text-white border-none rounded-[3rem] shadow-xl relative overflow-hidden group">
