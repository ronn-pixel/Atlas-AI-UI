...
export default function Payments() {
  return (
    <div className="space-y-8 animate-in fade-in duration-700 pb-12">
      <div>
        <h1 className="text-3xl font-black text-text-primary dark:text-white tracking-widest uppercase">Financial Settlements</h1>
        <p className="text-text-muted dark:text-slate-500 text-[11px] font-black uppercase tracking-[0.4em] mt-2">Capital Matrix & Disbursement Telemetry</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <Card className="p-10 border-none bg-white dark:bg-[#1F2937] rounded-[3rem] shadow-soft flex flex-col justify-between h-64">
        ...
        <Card className="p-10 border-none bg-white dark:bg-[#1F2937] rounded-[3rem] shadow-soft flex flex-col justify-between h-64">
           <div className="flex justify-between items-start">
              <div className="w-14 h-14 bg-trust/10 text-trust rounded-2xl flex items-center justify-center">
        ...
        <Card className="p-10 border-none bg-slate-900 text-white rounded-[3rem] shadow-xl shadow-black/20 flex flex-col justify-between h-64 relative overflow-hidden group">
      ...
      <Card className="overflow-hidden bg-white dark:bg-[#1F2937] border-none rounded-[3rem] shadow-soft">
         <div className="p-10 flex items-center justify-between bg-slate-50/50 dark:bg-black/20">
            ...
            <div className="flex gap-4">
               <div className="relative">
                  ...
                  <input type="text" placeholder="Scan ledger..." className="bg-white dark:bg-[#111827] border-none rounded-xl pl-12 pr-6 h-10 text-[10px] font-black tracking-widest w-64 uppercase outline-none" />
               </div>
         ...
         <div className="p-20 text-center space-y-6">
            <div className="w-24 h-24 bg-slate-50 dark:bg-black/20 rounded-[2.5rem] flex items-center justify-center mx-auto">
